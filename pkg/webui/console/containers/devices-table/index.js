  ...
  },
  {
    ...
    render: lastSeen =>
      lastSeen ? (
        ...
        <Status status="mediocre" label={sharedMessages.unknown} className={style.none} />
      ),
  },
]
...
class DevicesTable extends React.Component {
  ...
  baseDataSelector(state) {
    ...
    for (const device of devices) {
      device._derivedLastSeen = selectDeviceDerivedLastSeen(state, appId, device.ids.device_id)
    }
    return {
      devices,
